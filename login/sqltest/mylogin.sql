...
--
-- Host: localhost
-- Generation Time: Feb 07, 2013 at 05:25 PM
...
-- Database: `basicuser`
--
CREATE DATABASE `basicuser` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `basicuser`;
...
('HTML DOM alt Property', 'http://www.w3schools.com/htmldom/prop_img_alt.asp'),
('HTML DOM height Property', 'http://www.w3schools.com/htmldom/prop_img_height.asp'),
('HTML a tag', 'http://www.w3schools.com/tags/tag_a.asp'),
('HTML br tag', 'http://www.w3schools.com/tags/tag_br.asp'),
('CSS background Property', 'http://www.w3schools.com/css/pr_background.asp'),
('CSS border Property', 'http://www.w3schools.com/css/pr_border.asp'),
('JavaScript Date() Method', 'http://www.w3schools.com/jsref/jsref_date.asp'),
('JavaScript anchor() Method', 'http://www.w3schools.com/jsref/jsref_anchor.asp');
--
-- Database: `egco423`
--
CREATE DATABASE `egco423` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `egco423`;

-- --------------------------------------------------------

--
-- Table structure for table `placeus`
--

CREATE TABLE IF NOT EXISTS `placeus` (
...
--
-- Dumping data for table `placeus`
--

INSERT INTO `placeus` (`name`, `city`, `icon`, `date`) VALUES
('Bridge', 'San Francisco', 'bridge.jpg', 'Monday, August 27, 2012'),
('Casino', 'Las Vegas', 'casino.jpg', 'Tuesday, August 28, 2012'),
('Museum', 'Seattle', 'museum.jpg', 'Wednesday, August 29, 2012');

-- --------------------------------------------------------

--
-- Table structure for table `travelus`
--

CREATE TABLE IF NOT EXISTS `travelus` (
  `name` varchar(50) NOT NULL,
  `city` varchar(25) NOT NULL,
  `icon` varchar(50) NOT NULL,
  `date` varchar(50) NOT NULL
...
--
-- Dumping data for table `travelus`
--

INSERT INTO `travelus` (`name`, `city`, `icon`, `date`) VALUES
('Bob Cat', 'New York', 'cat.jpg', 'Tuesday, August 28, 2012'),
('Mary Bird', 'Florida', 'bird.jpg', 'Monday, August 27, 2012'),
('Jame Mouse', 'Ohio', 'mouse.jpg', 'Wednesday, August 29, 2012');
--
...
('def', 'basicuser', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'basicuser', 'users', 'username', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'basicuser', 'users', 'password', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'class', 'links', 'title', 1, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'class', 'links', 'url', 2, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'placeus', 'name', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'placeus', 'city', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'placeus', 'icon', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'placeus', 'date', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'travelus', 'name', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'travelus', 'city', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'travelus', 'icon', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'egco423', 'travelus', 'date', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'mylogin', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'mylogin', 'users', 'name', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'mylogin', 'users', 'username', 3, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'mylogin', 'users', 'password', 4, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'mylogin', 'users', 'date', 5, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
...
('def', 'person', 'ajaxdb', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'ajaxdb', 'firstname', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'ajaxdb', 'lastname', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'ajaxdb', 'age', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'ajaxdb', 'hometown', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'ajaxdb', 'job', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'firstname', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'lastname', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'city', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'country', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'telephone', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'person', 'personinfo', 'email', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'firstname', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'lastname', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'city', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'country', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'telephone', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'persons', 'personinfo', 'email', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'simplelogin', 'basicusers', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'simplelogin', 'basicusers', 'username', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'simplelogin', 'basicusers', 'password', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'simplelogin', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'simplelogin', 'users', 'username', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'simplelogin', 'users', 'password', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'xmltest', 'cities', 'name', 1, '', 'NO', 'char', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(35)', '', '', 'select,insert,update,references', ''),
('def', 'xmltest', 'cities', 'country', 2, '', 'NO', 'char', 52, 52, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(52)', '', '', 'select,insert,update,references', ''),
('def', 'xmltest', 'cities', 'population', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'xmltest', 'links', 'title', 1, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'xmltest', 'links', 'url', 2, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', '');
...
('COM_SHOW_SLAVE_STATUS', '19'),
('COM_SHOW_STATUS', '0'),
('COM_SHOW_STORAGE_ENGINES', '0'),
('COM_SHOW_TABLE_STATUS', '142'),
('COM_SHOW_TABLES', '407'),
('COM_SHOW_TRIGGERS', '18'),
('COM_SHOW_VARIABLES', '60'),
('COM_SHOW_WARNINGS', '8'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FREE', '8017'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1028'),
...
('INNODB_DATA_READ', '5066752'),
('INNODB_DATA_READS', '186'),
...
('KEY_BLOCKS_USED', '11'),
('KEY_READ_REQUESTS', '110'),
('KEY_READS', '11'),
('KEY_WRITE_REQUESTS', '66'),
('KEY_WRITES', '26'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '13187'),
('UPTIME_SINCE_FLUSH_STATUS', '13187');
...
('BASEDIR', 'd:/wamp/bin/mysql/mysql5.5.8'),
...
('FT_MAX_WORD_LEN', '84'),
('PID_FILE', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\Artemis.pid'),
...
('SQL_NOTES', 'ON'),
('LC_MESSAGES_DIR', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\share\\'),
...
('GENERAL_LOG_FILE', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\Artemis.log'),
('SQL_BIG_SELECTS', 'ON'),
...
('TIMED_MUTEXES', 'OFF'),
('DATADIR', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\'),
...
('HAVE_GEOMETRY', 'YES'),
('SLOW_QUERY_LOG_FILE', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\data\\Artemis-slow.log'),
...
('LC_TIME_NAMES', 'en_US'),
('PLUGIN_DIR', 'd:\\wamp\\bin\\mysql\\mysql5.5.8\\lib/plugin'),
('TIME_FORMAT', '%H:%i:%s'),
...
('def', 'basicuser', 'PRIMARY', 'def', 'basicuser', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'basicuser', 'username', 'def', 'basicuser', 'users', 'username', 1, NULL, NULL, NULL, NULL),
...
('def', 'simplelogin', 'PRIMARY', 'def', 'simplelogin', 'basicusers', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'simplelogin', 'username', 'def', 'simplelogin', 'basicusers', 'username', 1, NULL, NULL, NULL, NULL),
('def', 'simplelogin', 'PRIMARY', 'def', 'simplelogin', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'simplelogin', 'username', 'def', 'simplelogin', 'users', 'username', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:17', '2013-02-08 00:25:17', NULL, NULL, '', '', NULL),
...
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-02-08 00:25:18', '2013-02-08 00:25:18', NULL, NULL, '', '', NULL),
...
('def', 'basicuser', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 46, 140, 281474976710655, 9216, 0, '2013-02-08 00:01:32', '2013-02-08 00:01:33', NULL, NULL, '', '', NULL),
('def', 'class', 'links', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 71, 572, 281474976710655, 1024, 0, '2013-02-07 20:53:52', '2013-02-07 20:53:54', NULL, NULL, '', '', NULL),
('def', 'egco423', 'placeus', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 9437184, '2011-09-12 15:54:47', NULL, NULL, NULL, '', '', NULL),
('def', 'egco423', 'travelus', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 9437184, '2011-09-12 15:55:09', NULL, NULL, NULL, '', '', NULL),
('def', 'mylogin', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 32, 64, 281474976710655, 1024, 0, '2011-09-04 12:49:59', '2011-09-04 12:50:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2010-12-04 01:18:58', '2010-12-31 08:40:00', '2010-12-04 01:19:04', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-12-04 01:19:03', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 453, 197, 89241, 55450570411999231, 16384, 0, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 992, 9, 8928, 2533274790395903, 18432, 0, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 505, 829, 418976, 281474976710655, 20480, 0, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-12-04 01:19:03', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2010-12-04 01:19:04', '2010-12-31 08:40:00', '2010-12-04 01:19:04', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 50, 200, 281474976710655, 2048, 0, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, NULL, '', '', NULL),
...
('def', 'person', 'ajaxdb', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2011-08-27 21:13:05', NULL, NULL, NULL, '', '', NULL),
('def', 'person', 'personinfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 51, 204, 281474976710655, 1024, 0, '2011-08-20 17:01:42', '2011-08-20 17:01:44', NULL, NULL, '', '', NULL),
('def', 'persons', 'personinfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 51, 204, 281474976710655, 1024, 0, '2011-08-22 17:14:27', '2011-08-22 17:14:29', NULL, NULL, '', '', NULL),
('def', 'simplelogin', 'basicusers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 46, 140, 281474976710655, 9216, 0, '2013-02-08 00:03:00', '2013-02-08 00:05:50', NULL, NULL, '', '', NULL),
('def', 'simplelogin', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 58, 176, 281474976710655, 9216, 0, '2013-02-07 23:26:27', '2013-02-07 23:51:00', NULL, NULL, '', '', NULL),
('def', 'xmltest', 'cities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2011-08-13 18:38:38', NULL, NULL, NULL, '', '', NULL),
('def', 'xmltest', 'links', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 71, 572, 281474976710655, 1024, 0, '2011-08-20 17:04:48', '2011-08-20 17:04:48', NULL, NULL, '', '', NULL);
...
(213, 'root', 'localhost:10239', 'egco423', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'basicuser', 'utf8', 'utf8_general_ci', NULL),
('def', 'class', 'utf8', 'utf8_general_ci', NULL),
('def', 'egco423', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mylogin', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'person', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'persons', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'simplelogin', 'utf8', 'utf8_general_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'xmltest', 'latin1', 'latin1_swedish_ci', NULL);
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2276'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2322'),
('INNODB_BUFFER_POOL_PAGES_DATA', '176'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '1'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '13191'),
('UPTIME_SINCE_FLUSH_STATUS', '13191');
...
('def', 'basicuser', 'users', 0, 'basicuser', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'basicuser', 'users', 0, 'basicuser', 'username', 1, 'username', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'simplelogin', 'basicusers', 0, 'simplelogin', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'simplelogin', 'basicusers', 0, 'simplelogin', 'username', 1, 'username', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'simplelogin', 'users', 0, 'simplelogin', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'simplelogin', 'users', 0, 'simplelogin', 'username', 1, 'username', 'A', 3, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
...
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
...
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-02-08 00:25:21', '2013-02-08 00:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
...
('def', 'basicuser', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 46, 140, 281474976710655, 9216, 0, 4, '2013-02-08 00:01:32', '2013-02-08 00:01:33', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'class', 'links', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 71, 572, 281474976710655, 1024, 0, NULL, '2013-02-07 20:53:52', '2013-02-07 20:53:54', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'egco423', 'placeus', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 9437184, NULL, '2011-09-12 15:54:47', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'egco423', 'travelus', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 9437184, NULL, '2011-09-12 15:55:09', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mylogin', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 32, 64, 281474976710655, 1024, 0, NULL, '2011-09-04 12:49:59', '2011-09-04 12:50:04', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2010-12-04 01:18:58', '2010-12-31 08:40:00', '2010-12-04 01:19:04', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-12-04 01:19:03', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 453, 197, 89241, 55450570411999231, 16384, 0, NULL, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 992, 9, 8928, 2533274790395903, 18432, 0, NULL, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 505, 829, 418976, 281474976710655, 20480, 0, NULL, '2010-12-04 01:19:01', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-12-04 01:19:03', '2010-12-31 08:40:00', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2010-12-04 01:19:04', '2010-12-31 08:40:00', '2010-12-04 01:19:04', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2010-12-04 01:19:02', '2010-12-31 08:40:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 50, 200, 281474976710655, 2048, 0, NULL, '2010-12-04 01:18:59', '2010-12-31 08:40:00', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'person', 'ajaxdb', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 9437184, NULL, '2011-08-27 21:13:05', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'person', 'personinfo', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 51, 204, 281474976710655, 1024, 0, NULL, '2011-08-20 17:01:42', '2011-08-20 17:01:44', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'persons', 'personinfo', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 51, 204, 281474976710655, 1024, 0, NULL, '2011-08-22 17:14:27', '2011-08-22 17:14:29', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'simplelogin', 'basicusers', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 46, 140, 281474976710655, 9216, 0, 4, '2013-02-08 00:03:00', '2013-02-08 00:05:50', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'simplelogin', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 58, 176, 281474976710655, 9216, 0, 4, '2013-02-07 23:26:27', '2013-02-07 23:51:00', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'xmltest', 'cities', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 9437184, NULL, '2011-08-13 18:38:38', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'xmltest', 'links', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 71, 572, 281474976710655, 1024, 0, NULL, '2011-08-20 17:04:48', '2011-08-20 17:04:48', NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'basicuser', 'PRIMARY', 'basicuser', 'users', 'PRIMARY KEY'),
('def', 'basicuser', 'username', 'basicuser', 'users', 'UNIQUE'),
...
('def', 'simplelogin', 'PRIMARY', 'simplelogin', 'basicusers', 'PRIMARY KEY'),
('def', 'simplelogin', 'username', 'simplelogin', 'basicusers', 'UNIQUE'),
('def', 'simplelogin', 'PRIMARY', 'simplelogin', 'users', 'PRIMARY KEY'),
('def', 'simplelogin', 'username', 'simplelogin', 'users', 'UNIQUE');
...
-- Database: `mylogin`
--
CREATE DATABASE `mylogin` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mylogin`;
...
(1, 'Lalita Naru', 'lalita', 'naru', '2011-01-11'),
(2, 'Bob Cat', 'bob', '123', '2011-01-11');
--
-- Database: `mysql`
--
...
('localhost', 'root', '', '', 1, '', '2010-12-04 01:19:04');
...
-- Database: `person`
--
CREATE DATABASE `person` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `person`;
...
CREATE TABLE IF NOT EXISTS `ajaxdb` (
  `id` int(11) NOT NULL,
...
INSERT INTO `ajaxdb` (`id`, `firstname`, `lastname`, `age`, `hometown`, `job`) VALUES
...
INSERT INTO `personinfo` (`firstname`, `lastname`, `city`, `country`, `telephone`, `email`) VALUES
('John', 'Doe', 'LA', 'USA', '111-1111', 'john.doe@person.com'),
('Jane', 'Doe', 'NY', 'USA', '222-2222', 'jane.doe@person.com'),
('Mary', 'Lamb', 'BK', 'Thailand', '333-3333', 'mary.lamb@person.com'),
('Bob', 'Cat', 'BK', 'Thaliand', '444-4444', 'bob.cat@person.com');
--
-- Database: `persons`
--
CREATE DATABASE `persons` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `persons`;
...
--
CREATE DATABASE `simplelogin` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `simplelogin`;
...
INSERT INTO `basicusers` (`id`, `username`, `password`) VALUES
(1, 'admin', 'password'),
(2, 'a', 'a'),
(3, 'aaa', 'aaa');
...
-- Database: `xmltest`
--
CREATE DATABASE `xmltest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `xmltest`;
